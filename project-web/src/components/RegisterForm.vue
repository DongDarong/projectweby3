    ...
    <div class="container mx-auto px-6">
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto">
        ...
        <form @submit.prevent="registerUser">
          ...
          <div class="mb-4">
            <label for="confirmPassword" class="block text-lg font-semibold text-gray-700">Confirm Password</label>
            <input 
          ...
          <div class="mb-6">
            <button type="submit" class="bg-teal-600 hover:bg-teal-700 text-white py-2 w-full rounded-lg">Register</button>
          </div>
...
const registerUser = () => {
  if (password.value === confirmPassword.value) {
    // Storing the token for demo purposes after registration
    localStorage.setItem('auth_token', 'demo_token');
    router.push('/order'); // Redirect to the order page after registration
  } else {
